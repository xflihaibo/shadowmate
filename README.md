...
### 6. 剪贴板记忆 (Clipboard Memory) 📋
智能记录你复制的内容，支持浏览器内和外部应用的复制检测。点击输入框自动填充最近复制的内容，使用上/下箭头键快速切换历史记录。所有数据本地存储，支持可视化管理。
...
**详细文档：** 查看 [剪贴板记忆功能文档](./docs/CLIPBOARD_MEMORY.md)
...
├── content.js         # 内容脚本：UI 注入、余晖滤镜、行为捕捉、剪贴板记忆
├── popup.html/js      # 仪表盘：2x2 今日统计、足迹列表、归航设置、剪贴板管理
